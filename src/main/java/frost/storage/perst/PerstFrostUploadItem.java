...
public class PerstFrostUploadItem extends Persistent {
    ...
    public FrostUploadItem toFrostUploadItem(final List<FrostSharedFileItem> sharedFiles, final Logger logger, final Language language) {
        ...
        if( Core.frostSettings.getBoolean(Settings.UPLOAD_REMOVE_NOT_EXISTING_FILES) && !file.isFile() ) {
        ...
        if( Core.frostSettings.getBoolean(Settings.UPLOAD_REMOVE_NOT_EXISTING_FILES) && file.length() != fileSize ) {
